  ...
  <form @submit.prevent="submitForm">
    <div class="w3-row form-ligne">
      ...
      <div class="w3-half form-cell">
        ...
        <input class="w3-input w3-border" type="text" id="description" v-model="form.categorie" required
          :disabled="props.isReadOnly" />
      </div>
      <!-- next id pour debug -->
...
onMounted(() => {
  console.log("TypeEquipementForm component mounted");
  ...
  if (!props.isEdit) {
    auth.axiosInstance
      ...
      .then((response) => {
        ...
        form.value.id_type_equipement = nextId.value; // Optionnel: lier cet ID au formulaire si besoin
      })
      .catch((error) => {
...
onBeforeUnmount(() => {
  console.log("TypeEquipementForm component before unmount");
});
</script>
