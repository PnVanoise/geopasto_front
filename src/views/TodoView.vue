...
export default {
    setup() {
        const tasks = ref(["Rédiger des spécifications", "Etudier le modèle bâti / usage / logement", "Peaufiner l'ensemble du modèle / Retours autres parcs", "Faire un petit coup de figma"]);
